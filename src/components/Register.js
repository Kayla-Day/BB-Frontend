      ...
      <Card.Body>
        <Row>
          <Col sm={6} mb={3} mb-sm={0}>
            ...
            <br />
            <br />
            <Card.Title>Complete the form to register </Card.Title>
          </Col>
          <Col sm={6}>
            <Form onSubmit={(e) => handleSubmit(e)}>
              ...
              {register ? (
                <p className="text-info">You Are Registered Successfully</p>
              ) : (
                <p className="text-warning">You Are Not Registered</p>
              )}
            </Form>
          </Col>
        </Row>
